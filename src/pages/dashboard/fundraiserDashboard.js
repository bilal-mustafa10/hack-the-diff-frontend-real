...
const FundraiserDashboard = () => {
    return(
        ...
        {/* next line should start in a new line */}
            ...
            <ReturnBox title="Donation 1" description="This is a description of donation 1" progress={45} strokeColor="#2df580"/>
            <ReturnBox title="Donation 2" description="This is a description of donation 2" progress={10} strokeColor="#2df580"/>
            <ReturnBox title="Donation 3" description="This is a description of donation 3" progress={25} strokeColor="#2df580"/>
